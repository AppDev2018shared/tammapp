...
@interface YSLContainerViewController1 () <UIScrollViewDelegate>

@property (nonatomic, assign) CGFloat topBarHeight;
@property (nonatomic, assign) NSInteger currentIndex;
//@property (nonatomic, strong) YSLScrollMenuView1 *menuView;

@end

@implementation YSLContainerViewController1
...
- (void)viewDidLoad {
    ...
    // meunView
//    _menuView = [[YSLScrollMenuView1 alloc]initWithFrame:CGRectMake(0, _topBarHeight, self.view.frame.size.width, kYSLScrollMenuViewHeight + 20)];
