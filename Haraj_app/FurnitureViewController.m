...
{
    return Array_Furniture.count;
}

-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    NSDictionary *dic_request=[Array_Furniture objectAtIndex:indexPath.row];
    NSLog(@"dic= %@",dic_request);
    
    if([NSNull null] ==[[Array_Furniture  objectAtIndex:0]valueForKey:@"mediatype"] ||[[dic_request valueForKey:@"mediatype"] isEqualToString:@"VIDEO"])
    {
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([[[Array_Furniture objectAtIndex:indexPath.row] valueForKey:@"userid1"]isEqualToString:[defaults valueForKey:@"userid"]])
    {
        set.Array_UserInfo = Array_Furniture;
    ...
    {
        set1.Array_UserInfo = Array_Furniture;
