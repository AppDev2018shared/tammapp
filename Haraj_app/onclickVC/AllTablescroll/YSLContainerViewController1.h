...
@protocol YSLContainerViewController1Delegate <NSObject>

- (void)containerViewItemIndex:(NSInteger)index currentController:(UIViewController *)controller;

@end

@interface YSLContainerViewController1 : UIViewController

@property (nonatomic, weak) id <YSLContainerViewController1Delegate> delegate;
...
@property (nonatomic,assign) NSInteger TuchedIndexCount;
