...
@interface OtherViewController ()<UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UICollectionViewDelegate,FRGWaterfallCollectionViewDelegate>
{
    ...
    NSMutableArray *Array_ViewPost ,*Array_Others;
}
...
{
    NSDictionary *dic_request=[Array_Others objectAtIndex:indexPath.row];
    NSLog(@"dic= %@",dic_request);
    
    if([NSNull null] ==[[Array_Others  objectAtIndex:0]valueForKey:@"mediatype"] ||[[dic_request valueForKey:@"mediatype"] isEqualToString:@"VIDEO"] )
    {
//    
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([[[Array_Others objectAtIndex:indexPath.row] valueForKey:@"userid1"]isEqualToString:[defaults valueForKey:@"userid"]])
    {
        set.Array_UserInfo = Array_Others;
    ...
    {
        set1.Array_UserInfo = Array_Others;
